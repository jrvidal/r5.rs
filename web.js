...
function integrateWasmJS() {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'web.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'web.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'web.temp.asm.js';
...
var ASM_CONSTS = [function($0, $1) { Module.STDWEB.from_js($0, (function(){Scheme.process (Module.STDWEB.to_js($1))})()); },
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "web.js.mem" : null;
...
Module['wasmTableSize'] = 27648;

Module['wasmMaxTableSize'] = 27648;
